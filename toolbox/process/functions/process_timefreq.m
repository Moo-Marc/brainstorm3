...
function sProcess = GetDescription() %#ok<DEFNU>
    ...
    sProcess.options.normalize.Comment = {'<FONT color="#a0a0a0"><B>None</B>: Save non-standardized time-frequency maps</FONT>', ...
                                          '<B>1/f compensation</B>: Multiply output power values by frequency', ...
                                          '<FONT color="#a0a0a0">1/f<SUP>2</SUP> compensation (default before Nov 2020)</FONT>'; ...
                                          'none', 'multiply2020', 'multiply'};
